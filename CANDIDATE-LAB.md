...
This creates `candidate-work/`. Save every answer there. You may use `man`, `--help`, and normal command-line tools, but do not edit anything under `assets/` or `scripts/`.
